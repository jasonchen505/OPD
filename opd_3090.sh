#!/bin/bash
# OPD reproduction script for 8x RTX 3090 (24GB)
# Based on on_policy_distillation.sh with modifications for limited GPU memory
...
mkdir -p "$LOG_DIR"
LOG_FILE="${LOG_DIR}/opd_3090_$(date +%Y%m%d_%H%M%S).log"
...
export PROJECT_NAME='OnPolicyDistillation-3090'
...
export MAX_RESP_LENGTH=2048
export MAX_VAL_RESP_LENGTH=2048
...
python3 -m verl.trainer.main_ppo \
    ...
    +reward_model.model.override_config.attn_implementation=sdpa \
